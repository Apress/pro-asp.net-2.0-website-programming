        ...
        <td>
            <table width="149" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td><asp:HyperLink id="HyperLink1" Runat="server" NavigateUrl="~/BasicWizard.aspx">Basic Wizard Example</asp:HyperLink></td>
                </tr>                               
                ...
                <tr>
                    ...
                    <td><asp:HyperLink id="HyperLink2" Runat="server" NavigateUrl="~/WizardExample.aspx">Advanced Wizard Example</asp:HyperLink></td>
                </tr>                               
                ...
                <tr>
                    ...
                    <td><asp:HyperLink id="HyperLink3" Runat="server" NavigateUrl="~/AddEmployee.aspx">Add Employee Wizard</asp:HyperLink></td>
                </tr>                               
