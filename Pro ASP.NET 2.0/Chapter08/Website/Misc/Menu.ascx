        ...
        <td>
            <table width="149" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td><asp:HyperLink id="HyperLink1" Runat="server" NavigateUrl="~/CommonSearchFunctions.aspx">Common Search Functions</asp:HyperLink></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><asp:HyperLink id="HyperLink3" Runat="server" NavigateUrl="~/EmployeeSearch.aspx">Simple / Advanced <BR />Search Demo</asp:HyperLink></td>
                </tr>
